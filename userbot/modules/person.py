...
Branch: master 
javes/userbot/modules/person.py / Jump to 
Find file 
Copy path 
 rekcah-pavi added custom pm message 
4c9788b 8 days ago 
1 contributor 
781 lines (684 sloc) 28.5 KB 
Raw
Blame
History
...
from userbot import CMD_HELP, ALIVE_NAME, PM_MESSAGE, 帝 ZØmBie 帝_NAME, 帝 ZØmBie 帝_MSG, ORI_MSG
...
帝 ZØmBie 帝_NAME = str(帝 ZØmBie 帝_NAME) if ALIVE_NAME else str(帝 ZØmBie 帝_MSG)
...
async def blockpm(block):
    ...
    if block.reply_to_msg_id:
        ...
        await block.edit("`帝 ZØmBie 帝: You've been blocked!`")
...
async def unblockpm(unblock):
    ...
    if unblock.reply_to_msg_id:
        ...
        await unblock.edit("`帝 ZØmBie 帝: You have been unblocked.`")
...
AFKSTR = [f"`帝 ZØmBie 帝:` ** {DEFAULTUSER} is offline just leave your message i will tell him,Thankyou **"]
